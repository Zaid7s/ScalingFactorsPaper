...
!! Working TestCase
    ...
    DO i = iMin, iMax
        ...
        ELSE
            U_UpperDiag(1, 1, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(1, 1, i+1))*a1
            U_UpperDiag(1, 2, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(1, 2, i+1))*a1
            U_UpperDiag(1, 3, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(1, 3, i+1))*a1
            U_UpperDiag(2, 1, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(2, 1, i+1))*a1
            U_UpperDiag(2, 2, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(2, 2, i+1))*a1
            U_UpperDiag(2, 3, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(2, 3, i+1))*a1
            U_UpperDiag(3, 1, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(3, 1, i+1))*a1
            U_UpperDiag(3, 2, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(3, 2, i+1))*a1
            U_UpperDiag(3, 3, i) = &
                                    (1.0_rDef/delta_Zi)*(A_Minus(3, 3, i+1))*a1
        END IF
    END DO
