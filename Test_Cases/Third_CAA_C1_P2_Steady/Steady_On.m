...
Second_TriDi    = importdata('TriDi_SecOrder_D_10_LHS_Diss_On_Mean.dat');
Fourth_TriDi    = importdata('TriDi_FouOrder_D_10_LHS_Diss_On_Mean.dat');
Sixth_TriDi     = importdata('TriDi_SixOrder_D_10_LHS_Diss_On_Mean.dat');
RDRP_TriDi      = importdata('TriDi_RDRPSten_D_10_LHS_Diss_On_Mean.dat');
...
figure(1)
    ...
    xlim([-10 10])
    print(['TriDi_Dissipation'], '-depsc', '-r900')
