...
Second_TriDi_Off01    = importdata('TriDi_LHS_Diss_Off_SecOrder_D_10_Time.dat');
Fourth_TriDi_Off01    = importdata('TriDi_LHS_Diss_Off_FouOrder_D_10_Time.dat');
Sixth_TriDi_Off01     = importdata('TriDi_LHS_Diss_Off_SixOrder_D_10_Time.dat');
RDRP_TriDi_Off01      = importdata('TriDi_LHS_Diss_Off_RDRPSten_D_10_Time.dat');
DRP_TriDi_Off01      = importdata('TriDi_LHS_Diss_Off__DRPSten_D_10_Time.dat');

Second_TriDi_On_01    = importdata('TriDi_LHS_Diss_On__SecOrder_D_10_Time.dat');
Fourth_TriDi_On_01    = importdata('TriDi_LHS_Diss_On__FouOrder_D_10_Time.dat');
Sixth_TriDi_On_01     = importdata('TriDi_LHS_Diss_On__SixOrder_D_10_Time.dat');
RDRP_TriDi_On_01      = importdata('TriDi_LHS_Diss_On__RDRPSten_D_10_Time.dat');
DRP_TriDi_On_01      = importdata('TriDi_LHS_Diss_On___DRPSten_D_10_Time.dat');
