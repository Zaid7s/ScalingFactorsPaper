...
A_S_BC      = 0.0_rDef*REAL(nBound, rDef)
A_Plus_BC   = (-2.0_rDef*epsi*(omega)*&
                COS(omega*(xMin/(1.0_rDef + 0.2006533_rDef)+time))*&
                (1.0_rDef-EXP(-time/tau1)))*REAL(nBound, rDef)
A_Minus_BC  = A_Minus_noBC*REAL(nBound, rDef) 
