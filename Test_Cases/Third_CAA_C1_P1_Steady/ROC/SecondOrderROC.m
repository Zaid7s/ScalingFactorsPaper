...
figure(1)
    ...
    hold on
    semilogy(Compact_TriDi_LUSGS(:, 1), Compact_TriDi_LUSGS(:, 2),'LineWidth', 1.0)
    hold on
    grid on
    grid minor
    legend('Second Order', 'Fourth Order', 'Sixth Order', 'RDRP', 'DRP',  ...
        ...
        xlabel('Iteration')
    ylabel('Residual')
   print(['C1P1_LUSGS_ROC'], '-depsc', '-r900')
...
figure(2)
    ...
    hold on
    semilogy(Compact_TriDi_Off01(:, 1), Compact_TriDi_Off01(:, 2),'LineWidth', 1.0)
    hold on
    grid on
    grid minor
    ax = gca;
   ...
   print(['C1P1_TriDi_Scaling_ROC'], '-depsc', '-r900')
...
figure(3)
    ...
    xlabel('Iteration', 'Fontsize', 14)
    ylabel('Residual', 'Fontsize', 14)
   print(['C1P1_TriDi_Dissipation_ROC'], '-depsc', '-r900')
...
figure(5)
    ...
    xlabel('Iteration', 'Fontsize', 14)
    ylabel('Residual', 'Fontsize', 14)
   print(['C1P1_ROC_E2_vs_RDRP'], '-depsc', '-r900')
...
figure(4)
    ...
    xlabel('Iteration', 'Fontsize', 14)
    ylabel('Residual', 'Fontsize', 14)
    print(['RDRP_ROC_C1P1'], '-depsc', '-r900')
