...
Second_TriDi    = importdata('TriDi_SecOrder_D_10_LHS_Diss_OffMean.dat');
Fourth_TriDi    = importdata('TriDi_FouOrder_D_10_LHS_Diss_OffMean.dat');
Sixth_TriDi     = importdata('TriDi_SixOrder_D_10_LHS_Diss_OffMean.dat');
RDRP_TriDi      = importdata('TriDi_RDRPSten_D_10_LHS_Diss_OffMean.dat');
...
figure(1)
    ...
    xlim([-10 10])
    print(['TriDi_No_Dissipation'], '-depsc', '-r900')
