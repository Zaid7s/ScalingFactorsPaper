MODULE GetOutflowBC_NormalizeMean
!! New Boundaries
    ...
    IMPLICIT NONE
    PRIVATE
    PUBLIC:: OutflowBC_NormalizeMean

    INTEGER, PARAMETER:: rDef = REAL64

    CONTAINS
         
    SUBROUTINE OutflowBC_NormalizeMean(   iMin            ,&
                                        iMax            ,&
                                        bMin            ,&
                                        bMax            ,&
                                        E               ,&
...
! dEdX for Interior Domain
    ...
    END SUBROUTINE OutflowBC_NormalizeMean

END MODULE GetOutflowBC_NormalizeMean
